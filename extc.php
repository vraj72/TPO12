...
<h3>EXTC applicants</h3>
    ...
    <?php
        ...
        $stmt ="SELECT application.stu_id, student.status FROM application inner join student on application.stu_id =student.stu_id where student.branch='EXTC' ;";
...
if($result){
	echo "<meta http-equiv=\"refresh\" content=\"0;URL=extc.php\">";
