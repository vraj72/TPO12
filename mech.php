...
<h3>Mechanical applicants</h3>
    ...
    <?php
        ...
        $stmt ="SELECT application.stu_id, student.status FROM application inner join student on application.stu_id =student.stu_id where student.branch='MECH' ;";
...
if($result){
	echo "<meta http-equiv=\"refresh\" content=\"0;URL=mech.php\">";
